...
#include "../../FParticleDesigner/src/widget/MpMainWindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MpMainWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MpMainWindow_t qt_meta_stringdata_MpMainWindow = {
    {
QT_MOC_LITERAL(0, 0, 12), // "MpMainWindow"
QT_MOC_LITERAL(1, 13, 11), // "slotOnAbout"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "MpMainWindow\0slotOnAbout\0"
};
...
void MpMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MpMainWindow *_t = static_cast<MpMainWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotOnAbout(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject MpMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MpMainWindow.data,
      qt_meta_data_MpMainWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MpMainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MpMainWindow.stringdata0))
        return static_cast<void*>(const_cast< MpMainWindow*>(this));
